      ...
      <>
        <Jumbotron style={styles.background}>
          ...
          <div style={styles.logo2}>
            <SocialIcon url='https://github.com/Iyad-Kader' target='_blank'/>
          </div>
